describe('requires-port', function () {
  ...
  it('never requires port numbers for file', function () {
    assume(required(8000, 'file')).false();
  });
  ...
  it('does not require port 80 for http', function () {
    ...
    assume(required('8000', 'http')).true();
    assume(required(8000, 'http')).true();
    assume(required(8000, 'http://')).true();
    assume(required(8000, 'http://www.google.com')).true();
  });
  ...
  it('does not require port 80 for ws', function () {
    ...
    assume(required('8000', 'ws')).true();
    assume(required(8000, 'ws')).true();
    assume(required(8000, 'ws://')).true();
    assume(required(8000, 'ws://www.google.com')).true();
  });
  ...
  it('does not require port 443 for https', function () {
    ...
    assume(required('8000', 'https')).true();
    assume(required(8000, 'https')).true();
    assume(required(8000, 'https://')).true();
    assume(required(8000, 'https://www.google.com')).true();
  });
  ...
  it('does not require port 443 for wss', function () {
    ...
    assume(required('8000', 'wss')).true();
    assume(required(8000, 'wss')).true();
    assume(required(8000, 'wss://')).true();
    assume(required(8000, 'wss://www.google.com')).true();
  });
  ...
  it('does not require port 21 for ftp', function () {
    ...
    assume(required('8000', 'ftp')).true();
    assume(required(8000, 'ftp')).true();
    assume(required(8000, 'ftp://')).true();
    assume(required(8000, 'ftp://www.google.com')).true();
  });
  ...
  it('does not require port 70 for gopher', function () {
    ...
    assume(required('8000', 'gopher')).true();
    assume(required(8000, 'gopher')).true();
    assume(required(8000, 'gopher://')).true();
    assume(required(8000, 'gopher://www.google.com')).true();
  });
});
